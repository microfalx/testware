...
public final class MethodDescriptor extends BaseDescriptor implements net.microfalx.testware.api.metadata.MethodDescriptor {

    private net.microfalx.testware.api.metadata.ClassDescriptor classDescriptor;
    ...
    @Override
    public net.microfalx.testware.api.metadata.ClassDescriptor getClassDescriptor() {
    ...
    public static class Builder extends BaseDescriptor.Builder<Builder, MethodDescriptor> {
        ...
        private final net.microfalx.testware.api.metadata.ClassDescriptor classDescriptor;
        private final Executable testMethod;

        public Builder(net.microfalx.testware.api.metadata.ClassDescriptor classDescriptor, Executable testMethod) {
