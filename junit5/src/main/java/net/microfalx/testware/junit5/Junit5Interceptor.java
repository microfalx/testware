package net.microfalx.testware.junit5;

import net.microfalx.testware.api.Hook;
import net.microfalx.testware.api.metadata.ClassDescriptor;
import net.microfalx.testware.junit5.annotation.*;
import net.microfalx.testware.spi.Test;
...
public class Junit5Interceptor implements InvocationInterceptor {
    ...
    private <T> T processHook(Hook.Type type, Invocation<T> invocation,
        ...
        try {
            ...
            net.microfalx.testware.spi.Hook.Builder builder = net.microfalx.testware.spi.Hook.create(Junit5Tracker.getMethodDescriptor(extensionContext, invocationContext.getExecutable())).type(type);
            builder.duration(Duration.ofNanos(duration));
            Junit5Tracker.registerHook(builder.build());
        }
    }

    private net.microfalx.testware.api.Test.Type getType(ClassDescriptor classDescriptor) {
        if (classDescriptor.isAnnotated(UnitTest.class)) {
            return net.microfalx.testware.api.Test.Type.UNIT;
        } else if (classDescriptor.isAnnotated(IntegrationTest.class)) {
            return net.microfalx.testware.api.Test.Type.INTEGRATION;
        } else if (classDescriptor.isAnnotated(PerformanceTest.class)) {
            return net.microfalx.testware.api.Test.Type.PERFORMANCE;
        } else if (classDescriptor.isAnnotated(FunctionalTest.class)) {
            return net.microfalx.testware.api.Test.Type.FUNCTIONAL;
        } else if (classDescriptor.isAnnotated(End2EndTest.class)) {
            return net.microfalx.testware.api.Test.Type.E2E;
        } else {
            return net.microfalx.testware.api.Test.Type.UNIT;
        }
    }
